...
G4Material* BucatiniMaterials::GetMaterial(const G4String matName) {
  ...
  if (!mat) {
    ...
    G4Exception("BucatiniMaterials::GetMaterial", "", FatalException, o.str().c_str());
  }
...
void BucatiniMaterials::CreateMaterials() {
  ...
  a = 1.01 * g / mole;
  G4Element* elementH = new G4Element(name = "Hydrogen", symbol = "H", z = 1., a); // Hidrogen

  a = 12.01 * g / mole;
  G4Element* elementC = new G4Element(name = "Carbon", symbol = "C", z = 6., a); // Carbon

  a = 16.00 * g / mole;
  G4Element* elementO = new G4Element(name = "Oxygen", symbol = "O", z = 8., a); // Oxygen

  a = 28.09 * g / mole;
  G4Element* elementSi = new G4Element(name = "Silicon", symbol = "Si", z = 14., a); // Silicon

  a = 18.9984 * g / mole;
  G4Element* elementF = new G4Element(name = "Fluorine", symbol = "F", z = 9., a); // Fluorine

  a = 63.546 * g / mole;
  G4Element* elementCu = new G4Element(name = "Copper", symbol = "Cu", z = 29., a); // Copper

  a = 65.38 * g / mole;
  G4Element* elementZn = new G4Element(name = "Zinc", symbol = "Zn", z = 30., a); // Zinc
  ...
  fFluorinatedPoly = new G4Material(name = "fluorinatedPolymer", 1.43 * g / cm3, 2);
  ...
  MPTAir->AddProperty("RINDEX", photonEnergy, refractiveindexAir)->SetSpline(true);
  ...
  MPTPolystyrene->AddProperty("RINDEX", photonEnergy, refractiveindexPolystyrene)->SetSpline(true);
  MPTPolystyrene->AddProperty("ABSLENGTH", photonEnergy, absLenPolystyrene)->SetSpline(true);
  MPTPolystyrene->AddProperty("SCINTILLATIONCOMPONENT1", photonEnergy, emissionPolystyrene)->SetSpline(true);
  ...
  MPTPMMAScint->AddProperty("RINDEX", photonEnergy, refractiveIndexPmma)->SetSpline(true);
  ...
  // ------------------------------------------ //
  // https://refractiveindex.info
  MPTPMMACher->AddProperty("RINDEX", photonEnergy, refractiveIndexPmma)->SetSpline(true);
  ...
  MPTSilicon->AddProperty("RINDEX", photonEnergy, refractiveIndexSilicon)->SetSpline(true);
